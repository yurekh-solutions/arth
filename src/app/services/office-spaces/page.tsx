...
const service = SERVICES.find((s) => s.slug === "office-spaces")!;

const processSteps = [
  { step: "01", title: "Consultation & Planning", description: "Understanding your vision, requirements, and business objectives to craft the perfect strategy." },
  { step: "02", title: "Design & Development", description: "Creating innovative designs that blend aesthetics, functionality, and sustainability." },
  { step: "03", title: "Execution & Quality Control", description: "Meticulous construction with rigorous quality checks at every milestone." },
  { step: "04", title: "Handover & Support", description: "Seamless transition with ongoing support to ensure complete satisfaction." },
];
...
export default function OfficeSpacesPage() {
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        title={service.title}
        subtitle="State-of-the-art work environments designed to boost productivity"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <ScrollReveal direction="up" delay={0}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Uncompromising standards in materials, craftsmanship, and finishes that stand the test of time.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.1}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Systematic project management ensuring every milestone is met on schedule, every time.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Future-forward designs with green building practices that minimize environmental impact.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-custom text-center">
          <ScrollReveal direction="up">
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white max-w-4xl mx-auto leading-snug">
              &ldquo;Creating workspaces where businesses thrive and people love to work&rdquo;
            </blockquote>
      ...
      {/* CTA */}
      <CTASection
        title="Interested in Premium Office Spaces?"
        subtitle="Let us help you find or create the perfect workspace for your team."
