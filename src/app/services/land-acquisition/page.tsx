...
const service = SERVICES.find((s) => s.slug === "land-acquisition")!;

const processSteps = [
  { step: "01", title: "Consultation & Planning", description: "Understanding acquisition goals, identifying target areas, and defining selection criteria." },
  { step: "02", title: "Design & Development", description: "Comprehensive site analysis, feasibility studies, and development potential assessment." },
  { step: "03", title: "Execution & Quality Control", description: "Due diligence, title verification, regulatory clearances, and secure transactions." },
  { step: "04", title: "Handover & Support", description: "Complete documentation, registration support, and post-acquisition advisory." },
];
...
export default function LandAcquisitionPage() {
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        title={service.title}
        subtitle="Strategic land procurement for optimal development potential"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <ScrollReveal direction="up" delay={0}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Thorough due diligence and verification processes ensuring secure, high-value acquisitions.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.1}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Efficient acquisition timelines with proactive regulatory management and swift closures.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Identifying parcels with sustainable development potential and minimal environmental impact.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-custom text-center">
          <ScrollReveal direction="up">
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white max-w-4xl mx-auto leading-snug">
              &ldquo;Securing strategic locations that unlock exceptional development potential&rdquo;
            </blockquote>
      ...
      {/* CTA */}
      <CTASection
        title="Need Help with Land Acquisition?"
        subtitle="Our expert team identifies and secures prime locations with maximum development potential."
