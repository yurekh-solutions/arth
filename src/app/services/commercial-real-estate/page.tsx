...
const service = SERVICES.find((s) => s.slug === "commercial-real-estate")!;

const processSteps = [
  { step: "01", title: "Consultation & Planning", description: "In-depth market analysis and strategic planning to identify optimal investment opportunities." },
  { step: "02", title: "Design & Development", description: "Creating developments that maximize ROI through innovative design and strategic positioning." },
  { step: "03", title: "Execution & Quality Control", description: "Rigorous quality management throughout construction ensuring world-class delivery." },
  { step: "04", title: "Handover & Support", description: "Complete post-delivery support including lease management and property maintenance." },
];
...
export default function CommercialRealEstatePage() {
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        title={service.title}
        subtitle="End-to-end commercial development solutions for maximum ROI"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <ScrollReveal direction="up" delay={0}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Every development meets international standards for quality, design, and long-term value appreciation.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.1}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Precision scheduling and milestone management ensuring timely project completion.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <div className="neumorphic p-8 text-center h-full">
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  Forward-thinking developments incorporating green building standards and smart technology.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="container-custom text-center">
          <ScrollReveal direction="up">
            <blockquote className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white max-w-4xl mx-auto leading-snug">
              &ldquo;Maximizing returns through strategic development and market expertise&rdquo;
            </blockquote>
      ...
      {/* CTA */}
      <CTASection
        title="Explore Commercial Real Estate Opportunities?"
        subtitle="Partner with us for end-to-end commercial development solutions that deliver exceptional value."
